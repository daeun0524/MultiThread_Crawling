...
public class Crawler6 extends Thread{
	...
	public void run()
	{
		...
		Elements element = doc.select("div.list_body.section_index");
		Elements list=element.select("div.cluster_text a");
